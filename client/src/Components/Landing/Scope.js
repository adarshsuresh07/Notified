                    ...
                    <div className="row">
                        <div className="modal-left">
                            <ul>
                                ...
                                <li>You will receive a mail and click on the link to verify</li>
                        ...
                        <div className="modal-right">
                            <ul>
                                ...
                                <li>To add to todo stack, Click on the button shown when you hover it, the opportunity will be added to your Todo stack</li>
